...
public class NoBracketFormPars extends FormPars {

    private Type Type;
    private String I2;
    private FormParsRList FormParsRList;

    public NoBracketFormPars (Type Type, String I2, FormParsRList FormParsRList) {
        this.Type=Type;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("NoBracketFormPars(\n");
